...
module.exports = function(config) {
  ...
  config.set({
    ...
    proxies: {
      ...
      "/js/directoryLinksProvider.js": "http://localhost:9876/base/src/js/directoryLinksProvider.js",
      ...
      "/js/links.js": "http://localhost:9876/base/src/js/links.js",
      ...
      "/js/placesProvider.js": "http://localhost:9876/base/src/js/placesProvider.js",
      "/js/ProviderManager.js": "http://localhost:9876/base/src/js/ProviderManager.js",
