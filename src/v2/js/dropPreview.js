...
(function(exports) {
  ...
  const gDropPreview = {
     ...
     * @return {Array} The re-arranged array of sites.
     */
    rearrange(aCell) {
     ...
     *
     * @param {Site} aSites The array of sites to insert into.
     * @param {Cell} aCell The drop target cell.
     */
    _insertDraggedSite(aSites, aCell) {
     ...
     *
     * @param {Site} aSites The array of sites containing the dragged site.
     * @param {Cell} aCell The drop target cell.
     */
    _repositionPinnedSites(aSites, aCell) {
     ...
     * and have not moved.
     *
     * @param {Site} aSites The array of sites to filter.
     * @param {Cell} aCell The drop target cell.
     * @return {Array} The filtered array of sites.
     */
    _filterPinnedSites(aSites, aCell) {
      let draggedSite = gDrag.draggedSite;
     ...
     *
     * @param {Cell} aCell The drop target cell.
     * @return {Object} The range of pinned cells.
     */
    _getPinnedRange(aCell) {
      let dropIndex = aCell.index;
      let range = {
        start: dropIndex,
        end: dropIndex
     ...
     *
     * @param {Site} aSites The array of sites to check.
     * @param {Cell} aCell The drop target cell.
     * @return {Boolean} Whether there is an overflowed pinned cell.
     */
    _hasOverflowedPinnedSite(aSites, aCell) {
     ...
     *
     * @param {Site} aSites The array of sites.
     * @param {Cell} aCell The drop target cell.
     */
    _repositionOverflowedPinnedSite(aSites, aCell) {
     ...
     */
    _indexOfLowerPrioritySite(aSites, aCell) {
  ...
  exports.gDropPreview = gDropPreview;
}(window));
